...
fn main() {
    ...
    println!(
        ...
        faker.image.category(200, 400, "business")
    );
    ...
    println!(
        "faker.number.phone_number_format() = {}",
        faker.phone_number.phone_number_format("A###-B###-C###")
    );
    println!(
        "faker.number.phone_formats() = {}",
        faker.phone_number.phone_formats()
    );
